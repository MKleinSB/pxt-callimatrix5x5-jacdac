namespace modules {
     ...
     * The 5x5 LED display
     */
    //% fixedInstance whenUsed block="Callimatrix5x5"
    export const calliMatrix = new LedClient("Callimatrix5x5?dev=self&num_pixels=25&num_columns=5&variant=Matrix")
    /**
      * Custom color picker
      */
...
namespace servers {
    function start() {
        ...
        jacdac.deviceDescription = "Callimatrix 5x5"
